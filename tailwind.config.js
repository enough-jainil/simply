...
module.exports = {
  ...
  theme: {
    fontFamily: {
      sans: ["var(--gh-font-heading)", ...defaultTheme.fontFamily.sans],
    ...
    extend: {
      ...
      boxShadow: {
        ...
        "4xl":
          "inset 0 0 0 0.1rem rgb(58 3 45 / 8%), 0 10px 20px rgb(58 3 45 / 4%), 0 2px 6px rgb(58 3 45 / 4%), 0 0 1px rgb(58 3 45 / 4%)",
        "card-primary":
          "inset 0 0 0 0.1rem var(--color-primary), 0 10px 20px rgb(58 3 45 / 4%), 0 2px 6px rgb(58 3 45 / 4%), 0 0 1px rgb(58 3 45 / 4%)",
      },
      inset: {
        32: "8rem",
        24: "6rem",
